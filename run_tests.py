...
from nist_suite.t1_frequency import *
from nist_suite.t2_frequency_within_block import *
from nist_suite.t3_runs import *
from nist_suite.t4_longest_run import *
from nist_suite.t5_binary_matrix_rank import *

from nist_suite.t6_spectral import *
from nist_suite.t7_non_overlapping import *
from nist_suite.t8_overlapping import *
from nist_suite.t9_maurer import *
from nist_suite.t10_linear_complexity import *

from nist_suite.t11_serial import *
from nist_suite.t12_approximate_entropy import *
from nist_suite.t13_cumulative_sums import *
from nist_suite.t14_random_excursions import *
from nist_suite.t15_random_excursions_variant import *

from additional_suite.additional_stats import *
...
def run_nist(bits):
    ...
    try:
        p_val = maurers_universal_test(bits)
        log_test_result("9. Maurer's Universal Test", p_val, p_val >= alpha)
    except Exception: 
    ...
    try:
        ...
        log_test_result("15. Random Excursions Variant Test (mean P)", p_val, p_val >= alpha)
    except Exception: 
        log_test_result("15. Random Excursions Variant Test", 0.0, False)

    # 16. Chi Square Byte Test 
    try:
        p_val = chi_square_byte_test(bits)
        log_test_result("1 Additional. Chi Square Byte Test", p_val, p_val >= alpha)
    except Exception: 
        log_test_result("1 Additional. Chi Square Byte Test", 0.0, False)

    # 17. Autocorrelation Test
    try:
        p_val = autocorrelation_test(bits)
        log_test_result("2 Additional. Autocorrelation Test", p_val, p_val >= alpha)
    except Exception: 
        log_test_result("2 Additional. Autocorrelation Test", 0.0, False)
